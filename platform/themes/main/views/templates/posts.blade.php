            ...
            <div class="main-slider owl-carousel">
                <div class="new--slider__item">
                    ...
                    <div class="content">
                        ...
                        <span class="new--des font18 font-helve">Nhật Bản cho biết việc hồi sinh ngành chất bán dẫn là
    ...
    <div class="container">
       <div class="new">
          <div class="row mb-5">
             <div class="col-md-4">
               <a href="">
                  <img src="{{ Theme::asset()->url('images/new/new1.jpg') }}" alt="" class="img-slider" alt="">
               </a>
               <a href="">
                  <span class="new--title font-helve font20">Gama Service và “Hội nghị gắn kết
                     giáo dục nghề nghiệp thủ đô với thị tr Lorem ipsum dolor sit amet consectetur adipisicing</span>
               </a>
               <div class="new--time font-helve font12">
                  <span class="new--info">Kinh Doanh</span>
                  <span class="new--item">15/03/2021</span>
               ...
               <span class="new--des font-helve font18">Sáng 24/4, tại Hội nghị gắn kết giáo dục nghề nghiệp thủ đô 2021, Gama Service đã cùng Hiệp hội Thang máy Việt Nam (VNEA) i Hội nghị gắn kết giáo dục nghề nghiệp thủ đô 2021, </span>
             </div>
             <div class="col-md-4">
               <a href="">
                  <img src="{{ Theme::asset()->url('images/new/new1.jpg') }}" alt="" class="img-slider" alt="">
               ...
               <span class="new--des font-helve font18">Sáng 24/4, tại Hội nghị gắn kết giáo dục nghề nghiệp thủ đô 2021, Gama Service đã cùng Hiệp hội Thang máy Việt Nam (VNEA) </span>
             </div>
             <div class="col-md-4">
               <a href="">
                  <img src="{{ Theme::asset()->url('images/new/new1.jpg') }}" alt="" class="img-slider" alt="">
    ...
    <div class="container mb-5">
      <nav aria-label="Page navigation example">
         <ul class="pagination font-helve font20">
           ...
           <li class="page-item">
             <a class="page-link" href="#">Trang tiếp <img src="{{ Theme::asset()->url('images/new/next.png') }}" alt=""></a>
           </li>
         </ul>
       </nav>
    </div>
