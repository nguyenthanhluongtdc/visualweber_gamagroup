...
<div class="partner-orona">
    <div class="container">
        <div class="row">
            <h2 class="col-md-4 font-helve font30">
                Đặc điểm ưu việt <br>
                của thang máy Orona
            </h2>
            <div class="col-md-8">
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="font-helve-bold font20">An Toàn Tuyệt Đối</h3>
                    ...
                    <div class="col-md-6">
                        <h3 class="font-helve-bold font20">May đo theo thực tế công trình</h3>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="font-helve-bold font20">Chất lượng xanh Châu Âu</h3>
                    ...
                    <div class="col-md-6">
                       <h3 class="font-helve-bold font20">Dịch vụ bảo hành, bảo trì toàn cầu</h3> 
                       <p class="font-helve font18">Hệ thống vi xử lý thông minh giúp trung tâm quản lý vận hành tại Tây Ban Nha có thể hướng dẫn và xử lý kỹ thuật thông qua internet. Tất cả các thang máy Orona được bảo hành toàn cầu chính hãng lên tới 36 tháng. </p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="font-helve-bold font20">Thiết kế sang trọng, lịch lãm </h3>
                    ...
                    <div class="col-md-6">
                    <h3 class="font-helve-bold font20">Hỗ trợ khẩn cấp 24/7</h3> 
